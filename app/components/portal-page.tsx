...
export function AccessPending({ member }: { member: Member }) { return <main className="pending-page"><Image src="/rvr-crest.png" width={90} height={90} alt="Rivervalley Rangers AFC crest" /><p>RVR 2014 TEAM ADMIN</p><h1>Access unavailable</h1><span>{member.email} does not currently have permission to view this area.</span><a href="/">Return to overview</a></main>; }
